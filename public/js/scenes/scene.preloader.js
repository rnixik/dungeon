var sceneConfigPreloader = {
    ...
    preload: function() {
        ...
        this.load.image('scroll_of_protection', 'assets/MiniRouge/1 - Decor/Decor/32x32/Shield2x.png');
        this.load.image('cloak_of_invisibility', 'assets/MiniRouge/1 - Decor/Decor/32x32/Potion Mana2x.png');
    ...
    create: function() {
        ...
        this.anims.create({
            key: 'knight_walk',
            frames: this.anims.generateFrameNumbers('knight_move', { start: 0, end: 7 }),
            frameRate: 10,
            repeat: -1
        });
        this.anims.create({
